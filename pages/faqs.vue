    ...
    return {
      faqs: [
        ...
        },
        {
          ...
          a:
            'During the import process you can choose to edit any of the automatically generated metadata. Any changes you make will be saved and reflected in the artifact once you’ve published it.<br/><br/> If your artifact is already published and needs revision, please contact the SEARCCH team using the feedback form.'
        },
        {
        ...
        },
        {
          ...
          a:
            'Please do not submit feedback if you are having issues with a tool. The SEARCCH team does not have direct experience with most of the artifacts that are in the system and will be unable to provide assistance. <br/><br/> First contact the author and try to work out any issues or misunderstandings. Use the SEARCCH entry to identify the tool’s owner/author, and contact the owner directly for tool support. If you still have issues with the tool after reaching out for support, you can try asking a question using the review tool and leaving your contact info there. <br/><br/>You can also share your experience with the tool by leaving a review of the artifact in the hub. Please try to be constructive, understanding that most tools are not products; they are typically shared for use “as is”. If the tool is not maintained, leaving a review that says so and giving the artifact a low rating can help others. We also encourage sharing positive experiences.'
        },
        {
          q:
            'I found a dataset in the Hub, but the data is wrong, malformed, or mislabeled. How do I get help or submit feedback?',
          a:
            'Please do not submit feedback if you are having issues with a dataset. The SEARCCH team does not have direct experience with most of the artifacts that are in the system and will be unable to provide assistance. <br/><br/> First contact the author and try to work out any issues or misunderstandings. Use the SEARCCH entry to identify the dataset’s owner/author, and contact the owner directly for support. If you still have issues with the dataset after reaching out for support, you can try asking a question using the review feature. Be sure to leave your contact information so folks can reach out to you. <br/><br/> You can also share your experience using the data by leaving a review of the artifact in the hub. Please try to be constructive in your comments. E.g., if you found a way to fix broken labeling and were then able to use the dataset, share how to do that. We also encourage sharing positive experiences.'
        },
        {
          q: 'How do I add a profile picture?',
          a:
            'Direct profile picture upload is not yet supported. The hub automatically uses your GitHub avatar. If you do not have a GitHub avatar, the hub queries gravatar.com for profile pictures associated with your registered SEARCCH email address. <br/><br/> If you would like your profile picture to show up in the SEARCCH hub, either set an avatar image on GitHub.com by visiting <a href="https://github.com/settings/profile" target="_blank" rel="noopener">https://github.com/settings/profile</a> or go to <a href="https://gravatar.com" target="_blank" rel="noopener">https://gravatar.com</a> and register (or add) the email address you used for SEARCCH.'
        },
        {

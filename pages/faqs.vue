    ...
    return {
      faqs: [
        ...
        },
        {
          ...
          a:
            'Use the SEARCCH importer service to import artifacts into the SEARCCH hub. Please note that SEARCCH is a database of artifact metadata and does not store artifacts for you. Artifacts must be published on the internet with a valid URL to be imported into the hub. SEARCCH supports assisted import and fully manual import.  Artifacts published on github, ACM digital library, ieeexplore, and Zenodo can be imported using the assisted import function (the default). The import assistant will scan artifacts in these repositories and automatically populate the import web form for user review. The user can accept the field contents as is or make any modifications desired. Artifacts located in other online locations such as on personal websites can be manually imported by the user entering all the fields required. Entered data may be saved iteratively by clicking SAVE. Please visit  <a href="https://hub.cyberexperimentation.org/importer">https://hub.cyberexperimentation.org/importer</a> to start importing your work.'
        },
        {
          q:
